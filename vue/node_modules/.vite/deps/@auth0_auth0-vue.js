...
var p = { name: "auth0-spa-js", version: "2.0.1" };
var m = () => Date.now();
...
var x = async (e, t, i, o, n, a2, s2 = 1e4) => n ? (async (e2, t2, i2, o2, n2, a3, s3) => {
  ...
  let n2;
  return t2.signal = o2.signal, Promise.race([j(e2, t2), new Promise((e3, t3) => {
    n2 = setTimeout(() => {
...
async function O(e, t) {
  ...
  return await async function(e2, t2, i2, o2, n2, a3, r3) {
    ...
    for (let s2 = 0; s2 < 3; s2++)
      try {
        c3 = await x(e2, i2, o2, n2, a3, r3, t2), l3 = null;
        break;
      } catch (e3) {
        l3 = e3;
      }
    ...
    if (!m2) {
      ...
      throw new f(u2 || "request_error", t3);
    }
    return p2;
...
var H = { get(e) {
  ...
  let o = {};
  "https:" === window.location.protocol && (o = { secure: true, sameSite: "none" }), (null == i ? void 0 : i.daysUntilExpire) && (o.expires = i.daysUntilExpire), (null == i ? void 0 : i.cookieDomain) && (o.domain = i.cookieDomain), J(e, JSON.stringify(t), o);
}, remove(e, t) {
  let i = {};
...
var Y = { get: (e) => H.get(e) || H.get(`_legacy_${e}`), save(e, t, i) {
  let o = {};
  "https:" === window.location.protocol && (o = { secure: true }), (null == i ? void 0 : i.daysUntilExpire) && (o.expires = i.daysUntilExpire), J(`_legacy_${e}`, JSON.stringify(t), o), H.save(e, t, i);
}, remove(e, t) {
  let i = {};
...
var B = { memory: () => new K().enclosedCache, localstorage: () => new V() };
var Q = (e) => B[e];
var q = (e) => {
...
var ee = class {
      ...
      o2 = function(s2) {
        if (s2.data && "authorization_response" === s2.data.type) {
          if (clearTimeout(a3), clearInterval(n2), window.removeEventListener("message", o2, false), e2.popup.close(), s2.data.response.error)
            return i2(f.fromPayload(s2.data.response));
          t2(s2.data.response);
        }
  ...
  async handleRedirectCallback(e = window.location.href) {
    ...
    const { state: i, code: o, error: n, error_description: a2 } = ((e2) => {
      e2.indexOf("#") > -1 && (e2 = e2.substr(0, e2.indexOf("#")));
      const t2 = e2.split("&"), i2 = {};
      return t2.forEach((e3) => {
        const [t3, o2] = e3.split("=");
        i2[t3] = decodeURIComponent(o2);
      }), i2.expires_in && (i2.expires_in = parseInt(i2.expires_in)), i2;
    })(t.join("")), s2 = this.transactionManager.get();
    if (!s2)
      throw new Error("Invalid state");
    if (this.transactionManager.remove(), n)
      throw new g(n, a2 || n, i, s2.appState);
  ...
  async logout(e = {}) {
    ...
    await this.cacheManager.clear(), this.cookieStorage.remove(this.orgHintCookieName, { cookieDomain: this.options.cookieDomain }), this.cookieStorage.remove(this.isAuthenticatedCookieName, { cookieDomain: this.options.cookieDomain }), this.userCache.remove("@@user@@");
  ...
  async _getTokenFromIFrame(e) {
    ...
    try {
      if (window.crossOriginIsolated)
        throw new f("login_required", "The application is running in a Cross-Origin Isolated context, silently retrieving a token without refresh token is not possible.");
      const t2 = e.timeoutInSeconds || this.options.authorizeTimeoutInSeconds, i2 = await ((e2, t3, i3 = 60) => new Promise((o2, n2) => {
        ...
        r3 = function(e3) {
          ...
          if (!e3.data || "authorization_response" !== e3.data.type)
            return;
          const i4 = e3.source;
          i4 && i4.close(), e3.data.response.error ? n2(f.fromPayload(e3.data.response)) : o2(e3.data.response), clearTimeout(c3), window.removeEventListener("message", r3, false), setTimeout(s3, 2e3);
  ...
  async _requestToken(e, t) {
    const { nonceIn: i, organizationId: o } = t || {}, n = await O(Object.assign({ baseUrl: this.domainUrl, client_id: this.options.clientId, auth0Client: this.options.auth0Client, useFormData: this.options.useFormData, timeout: this.httpTimeoutMs }, e), this.worker), a2 = await this._verifyIdToken(n.id_token, i, o);
...
var ne = class {
  ...
  install(e) {
    this._client = new ee(Object.assign(Object.assign({}, this.clientOptions), { auth0Client: { name: "auth0-vue", version: "2.0.1" } })), this.__checkSession(e.config.globalProperties.$router), e.config.globalProperties.$auth0 = this, e.provide(a, this), oe.value = this;
  }
  async loginWithRedirect(e) {
  ...
  async __checkSession(e) {
    ...
    if ((o.includes("code=") || o.includes("error=")) && o.includes("state=") && !(null === (t = this.pluginOptions) || void 0 === t ? void 0 : t.skipRedirectCallback)) {
      const t2 = await this.handleRedirectCallback(), o2 = null == t2 ? void 0 : t2.appState, n = null !== (i = null == o2 ? void 0 : o2.target) && void 0 !== i ? i : "/";
      return window.history.replaceState({}, "", "/"), e && e.push(n), t2;
    }
...
async function ae(e, t) {
  const i = async () => !!unref(e.isAuthenticated) || (await e.loginWithRedirect({ appState: { target: t.fullPath } }), false);
  return unref(e.isLoading) ? (await ie(() => !unref(e.isLoading)), i()) : i();
}
function se(e) {
  return async (t) => ae(e.config.globalProperties.$auth0, t);
}
async function re(e) {
  return ae(unref(oe), e);
}
function ce(e, t) {
  return new ne(e, t);
}
